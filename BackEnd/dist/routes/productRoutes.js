...
product.post('/add-product', authMiddleware_1.default, productController_1.addProduct);
product.post('/add-basket', authMiddleware_1.default, productController_1.addMultipleProducts);
